...
void SEG_voidInit(u8_t SEG_NUM)
{
	...
	{
	case SEG1:
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINA ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINB ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINC ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PIND ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINE ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINF ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PING ,OUTPUT);
		DIO_u8SetPinDirection(SEG1_PORT , HSEG_PINH ,OUTPUT);
		break ;
	}
